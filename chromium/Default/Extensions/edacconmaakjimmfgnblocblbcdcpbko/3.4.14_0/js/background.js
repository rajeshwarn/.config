...
function requestCurrentWindow(openTabId) {
...
function evalSessionRoot(openTabId, cb) {
    var bMerge = '';
    var iRangeVal = [];
    if (openTabId) {
...
function iLinear(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache) {
    evalSessionRoot(undefined, function() {
        timerToCall(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache);
    });
}

function sbNodeRanges(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache) {
    evalSessionRoot(openTabId, function() {
        timerToCall(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache);
    });
}

function timerToCall(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache) {
    SBDB.lastFrameVal(openTabId, registerTab, recoverySessionVal, cb, iSearchRequest, extractCurrentSession, optDefaultRTypeVal, countWindowTabs, updateSessionCache);
}
...
function setUpSBDB(iWindowCount, cacheImportedSession) {
    ...
    arr.push(sSet('hidePanePositionUI', 'true'));
    ...
    arr.push('INSERT INTO SavedSessions (name, generationDateTime, creationDateTime, modificationDateTime, tags, users, deleted, thumbnail, windows, unfilteredWindowCount, filteredWindowCount, unfilteredTabCount, filteredTabCount) VALUES (\'Session Buddy\', \'' + headerDataSavedVal + '\', \'' + headerDataSavedVal + '\', \'' + headerDataSavedVal + '\', null, null, \'false\', \'' + xid() + '\', \'[{"nx_title":"How to","state":"normal","type":"normal","tabs":[{"favIconUrl":"http://sessionbuddy.com/backupRestore/logo_16x16.png","pinned":false,"title":"Back up Session Buddy Data","url":"http://sessionbuddy.com/backupRestore/backupRestore.html"},{"favIconUrl":"http://sessionbuddy.com/importExport/logo_16x16.png","pinned":false,"title":"Import and Export Session Buddy Data","url":"http://sessionbuddy.com/importExport/importExport.html"},{"favIconUrl":"http://sessionbuddy.com/DateFormatting/logo_16x16.png","pinned":false,"title":"Customize Date and Time Formats","url":"http://sessionbuddy.com/DateFormatting/dateFormatting.html"}]},{"nx_title":"Support","state":"normal","type":"normal","tabs":[{"favIconUrl":"http://sessionbuddy.com/support/troubleshooting/logo_16x16.png","pinned":false,"title":"Troubleshooting","url":"http://sessionbuddy.com/support/troubleshooting/"},{"favIconUrl":"https://groups.google.com/forum/favicon.ico","pinned":false,"title":"Session Buddy Forum","url":"https://groups.google.com/forum/?fromgroups#!forum/sessionbuddy-discuss"}]},{"nx_title":"Manage","state":"normal","type":"normal","tabs":[{"pinned":false,"title":"Settings","url":"chrome-extension://edacconmaakjimmfgnblocblbcdcpbko/options.html"},{"favIconUrl":"chrome://theme/IDR_EXTENSIONS_FAVICON@2x","pinned":false,"title":"Manage Extension","url":"chrome://extensions/?id=edacconmaakjimmfgnblocblbcdcpbko"},{"favIconUrl":"https://www.google.com/images/icons/product/chrome_web_store-32.png","pinned":false,"title":"Session Buddy in the Chrome Web Store","url":"https://chrome.google.com/webstore/detail/session-buddy/edacconmaakjimmfgnblocblbcdcpbko"}]}]\', 3, 0, 8, 0)');
...
function bShowURLsVal(cb) {
    SBDB.expectStatusVal('installationID', true, function(installationID) {
        ...
        installationID = installationID || xid();
