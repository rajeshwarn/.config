...
(function($)
{
  ...
  $.fn.oembed.insertCode = function(container, embedMethod, oembedData)
  {
    ...
    switch (embedMethod)
    {
      ...
      case "fill":
        ...
        break;
      case "append":
        container.closest('p').wrap('<div class="oembedall-container"></div>');
        var oembedContainer = container.closest('p').parent();
        ...
        try
        {
          oembedData.code.clone().prependTo(oembedContainer);
        } catch (e)
        {
          oembedContainer.prepend(oembedData.code);
        }
  ...
  $.fn.oembed.OEmbedProvider = function(name, type, urlschemesarray, apiendpoint, extraSettings)
  {
    ...
    if (extraSettings.useYQL)
    {
      ...
      {
        extraSettings.yql = {xpath: "//oembed/html", from: 'xml', apiendpoint: this.apiendpoint, url: function(externalurl)
        {
      ...
      {
        extraSettings.yql = {from: 'json', apiendpoint: this.apiendpoint, url: function(externalurl)
        {
  ...
  $.fn.oembed.providers = [
    ...
    {yql: {xpath: "//meta[contains(@content, \\'EmbeddedPlayer\\')]", from: 'html', datareturn: function(results)
    {
    ...
    {yql: {xpath: "json", from: 'json', url: function(externalurl)
    {
    ...
    {templateRegex: /mailto:([^\/]+).*/, template: function(wm, email)
    {
    ...
    {yql: {xpath: '(//div[@class="primary"])[1]', from: 'htmlstring', datareturn: function(results)
    {
      if (!results.result)
      {
        return false;
    ...
    {yql: {xpath: '//pre/font', from: 'htmlstring', datareturn: function(results)
    {
      if (!results.result)
      {
        return false;
    ...
    {yql: {xpath: "//meta|//title|//link", from: 'html', datareturn: function(results)
    {
